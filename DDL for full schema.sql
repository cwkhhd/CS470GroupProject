...
alter table Matches 
add constraint checknullfinals check(!(Match_type = "Finals" and Winner is null)),
add constraint checknullsemi check(!(Match_type = "Semi-Finals" and Winner is null)),
add constraint checknullquarter check(!(Match_type = "Quarter-Finals" and Winner is null)),
add constraint checknullsixteen check(!(Match_type = "Sixteen" and Winner is null));

select * from position_constraints;


delete from position constraints